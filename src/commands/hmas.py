...
async def add_hma_pick(interaction, pick):
    ...
    response_message = 'Your pick has been saved! You can check all of your picks by using `/my-hma-picks` or delete them with `/delete-hma-picks`.'
...
async def delete_hma_picks(interaction):
    ...
    response_message = 'Your HMA picks have been deleted. You can add new a new pick by using `/add-hma-pick`.'
    await interaction.response.send_message(response_message, ephemeral=True)