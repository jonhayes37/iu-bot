...
test_user = MockUser(id="test123")
pick = "IU is the best female soloist"
...
async def test_delete_hma_picks():
    ...
    new_interaction.assert_message_equals("You don't have any saved HMA picks yet! Add one by using `/add-hma-pick`.", ephemeral=True)
    cleanup()
